...
const EditExperimentStep2 = () => {
    ...
    const isValidFormSurvey =
        isValidTitleSurvey && title && isValidDescSurvey && description;
    ...
    const fetchSurvey = async () => {
        try {
            const response = await api.get(
                `survey2/experiment/${ExperimentId}`,
                {
        ...
        <Box>
            ...
            >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <IconButton
                                                    color="primary"
                                                    onClick={() =>
                                                        toggleSurveyDescription(
                                                            index
                                                        )
                                                    }
                                                    sx={{ ml: 1 }}
                                                >
                                                    {openSurveyIds.includes(
                                                        index
                                                    ) ? (
                                                        <ExpandLessIcon />
                                                    ) : (
                ...
                {isEditDialogOpen && (
                    ...
                    >
                        <DialogContent
                            sx={{ backgroundColor: "#f9f9f9", padding: 3 }}
                        >
                            <Typography
                                variant="h4"
                                gutterBottom
